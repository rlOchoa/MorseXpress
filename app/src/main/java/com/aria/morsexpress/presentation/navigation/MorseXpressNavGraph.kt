...
import com.aria.morsexpress.presentation.screen.imageinput.CameraCaptureActivity
...
object Routes {
    ...
    const val CAMERA_USAGE = "camera_usage_screen"
...
fun MorseXpressNavGraph(navController: NavHostController = rememberNavController()) {
    NavHost(navController = navController, startDestination = Routes.HOME) {
        ...
        composable(Routes.CAMERA_CAPTURE) { CameraInputSelectorScreen(navController) }
        composable(Routes.CAMERA_USAGE) { CameraCaptureActivity() }
